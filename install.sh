...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/caddy"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="caddy"
INSTDIR="$HOME/.local/share/dockermgr/caddy"
APPDIR="$HOME/.local/share/srv/docker/caddy"
DATADIR="$HOME/.local/share/srv/docker/caddy/files"
...
HUB_URL="casjaysdevdocker/caddy:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "caddy"; then
